...
/////////////////////////////////////////////////////////////
	this.rotateLeft  = function ( angle=getAutoRotationAngle())	{thetaDelta	-= angle;}
	this.rotateRight = function ( angle=getAutoRotationAngle())	{thetaDelta	+= angle;}
	this.rotateUp	 = function ( angle=getAutoRotationAngle())	{phiDelta	-= angle;}
	this.rotateDown  = function ( angle=getAutoRotationAngle())	{phiDelta	+= angle;}
	this.zoomIn 	 = function ( zoomScale= getZoomScale()   )	{scale		/= zoomScale;}
	this.zoomOut	 = function ( zoomScale= getZoomScale()   ) {scale		*= zoomScale;}
