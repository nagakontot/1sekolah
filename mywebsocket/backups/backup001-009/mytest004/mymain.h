...
public:    
    ...
    //template <typename T>      T& derived()       { return *static_cast<T*>(this);       }
    //template <typename T>const T& derived() const { return *static_cast<const T*>(this); }
...
template<class Dummy>std::vector<std::string>   baseUWS<Dummy>::storedMessages;
template<class Dummy>std::vector<int>           baseUWS<Dummy>::excludedMessages;
template<class Dummy>std::stringstream          baseUWS<Dummy>::indexHtml;
template<class Dummy>std::stringstream          baseUWS<Dummy>::mainHtml;
template<class Dummy>int                        baseUWS<Dummy>::connections;

template <typename T>
struct CServer: virtual public baseUWS<void> 
{   std::string mText;
...
template <typename T>                                                              
struct CWebpage: virtual public baseUWS<void>
{    std::string mText;
