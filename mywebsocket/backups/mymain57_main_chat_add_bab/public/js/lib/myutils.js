...
////////////////////////////////////////////////////////////////////////////////
    ...
    {   this.receiveMessage = function(event) 
        {   var eventData = event.data;
            ...
            {   case 'scrollToTop':     this.scrollToPageTop();break;
                case 'resizeIframe':    var height = eventData.params.height;this.resizeIframe(height);break;
                case 'talk':            var height = eventData.params.height;this.resizeIframe(height);break;
                default:                break;
            }
        };
    ...
    // USAGE: In Parent html, Initializing the communicator
...
//https://stackoverflow.com/questions/1796141/properly-bind-javascript-events
...
////////////////////////////////////////////////////////////////////////////////
//https://stackoverflow.com/questions/3763080/javascript-add-events-cross-browser-function-implementation-use-attachevent-add?noredirect=1&lq=1        
////////////////////////////////////////////////////////////////////////////////
        function bindEvent(html_element, event_name, event_function) 
...
////////////////////////////////////////////////////////////////////////////////
    ...
    function getX_from_Index(index,width)
    {   return (index % width);
    }
    		
    function getY_from_Index(index,width)
    {   return (index / width);
    }
