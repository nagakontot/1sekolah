    ...
    { return ()=>
      { if (this.isRunning_)
        { requestAnimationFrame(this.mainLoop);
          ...
          if (now - this.past >= this.frameSpan)
          { this.past = now;
            ...
            this.renderer[0].render.apply(this.renderer[0],this.currentScene.update()[0]);
            this.renderer[1].render.apply(this.renderer[1],this.currentScene.update()[1]);
            //////////////////////////////////////////////
            //return null;  //why ?
          }
        }
