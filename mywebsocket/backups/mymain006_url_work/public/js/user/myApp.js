"use strict"
	...
	*/
	...
	{	constructor(fps,width,height)
		...
		{	var promise = await new Promise((resolve, reject) =>
			{	window.setTimeout(()=>
				{	var params1=	[	[ [1.0,  0.2,  0.5], window.gTexLoader.load("//github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake1.png"), 0.8],
										[ [0.95, 0.1,  0.5], window.gTexLoader.load("//github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake2.png"), 0.5],
										[ [0.90, 0.05, 0.5], window.gTexLoader.load("//github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake3.png"), 0.3],
										[ [0.85, 0,    0.5], window.gTexLoader.load("//github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake4.png"), 0.2],
										[ [0.80, 0,    0.5], window.gTexLoader.load("//github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake5.png"), 0.1]
									];
		...
		{	//var pos = {x:83,y:-3,z:66};
			...
			{	window.setTimeout(()=>
				{	var pos			= {x:6,			y:-1.59,		z:85};		
					...
					var obj = new CLoadModel_WWObj2(pivot,glscene,'building4','https://raw.githubusercontent.com/nagakontot/1sekolah/master/mywebsocket/mymain/public/models/building4/','building4.obj.mtl','building4.obj',pos,rot,scale)
		...
		{	//var pos			= {x:0,			y:-1,		z:0};		
			...
			{	window.setTimeout(()=>
				{	var pos			= {x:0,			y:-1,		z:0};		
					...
					var obj 		= new CLoadModel_WWObj2(pivot,glscene,'castle01','https://raw.githubusercontent.com/nagakontot/1sekolah/master/mywebsocket/mymain/public/models/castle01/','castle01.obj.mtl','castle01.obj',pos,rot,scale);
		...
		{	//var pos			= {x:39.75,		y:-24.05,		z:-24.325};		
			...
			{	window.setTimeout(()=>
				{	var pos			= {x:39.75,		y:-24.05,		z:-24.325};		
					...
					var obj 		= new CLoadModel_Obj2(pivot,glscene,'https://raw.githubusercontent.com/nagakontot/1sekolah/master/mywebsocket/mymain/public/models/building1/','building1.mtl','building1.obj',pos,scale);
		...
		{	//var pos			= {x:0,			y:-1.99,	z:0};		
			...
			{	window.setTimeout(()=>
				{	var pos			= {x:0,			y:-1.99,	z:0};		
        			...
        			//this.building3  = new CLoadModel_Obj(glscene,'models/building3/','building3.mtl','building3.obj',pos,scale);
        			//return new CLoadModel_Obj(glscene,'models/building3/','building3.mtl','building3.obj',pos,scale);
					var obj			= new CLoadModel_Obj2(pivot,glscene,'https://raw.githubusercontent.com/nagakontot/1sekolah/master/mywebsocket/mymain/public/models/building3/','building3.mtl','building3.obj',pos,scale);
	...
	{ 	constructor(canvas="canvas",fps=30,width=window.innerWidth,height=window.innerHeight) 
		...
		{	//+-//////////////////////////////////////////////////////////////-+
			...
			this.floorTexture      		 = window.gTexLoader.load( 'https://raw.githubusercontent.com/nagakontot/1sekolah/master/mywebsocket/mymain/public/images/dirt/dirt_COLOR.jpg' );
	        ...
	        this.floorTextureBump    	= window.gTexLoader.load( 'https://raw.githubusercontent.com/nagakontot/1sekolah/master/mywebsocket/mymain/public/images/dirt/dirt_NRM.jpg' );
	        
	        this.floorTextureOCC     	= window.gTexLoader.load( 'https://raw.githubusercontent.com/nagakontot/1sekolah/master/mywebsocket/mymain/public/images/dirt/dirt_OCC.jpg' );

			this.doortex 				= window.gTexLoader.load( 'https://raw.githubusercontent.com/nagakontot/1sekolah/master/mywebsocket/mymain/public/images/house/door004.jpg' );
		...
		//+-//////////////////////////////////////////////////////////////-+
	    create_videostuff()
	    {	var videos = [	'https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/video/baby_1.webm',
							'https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/video/monkey_1.webm',
							'https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/video/robot_1.webm',
							'https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/video/billcat_1.webm'];
