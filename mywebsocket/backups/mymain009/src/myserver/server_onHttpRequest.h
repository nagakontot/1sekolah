...
*/                
                ...
                {   //already exist
                    std::cout<<"\nres "<<url.c_str()<<" already exist in map["<<mymap[url.c_str()]<<"], myfilecounter="<<myfilecounter;
                ...
                {   //insert new
                    ...
                    std::cout<<"\nnew res "<<url.c_str()<<" is created in map["<<mymap[url.c_str()]<<"], myfilecounter="<<myfilecounter;
