...
//g++ -std=c++14 mymain.cpp lib/GZipCodec/*.cpp lib/drecho/*.cpp lib/ltalloc/*.cpp -Wall -Wno-multichar -pedantic -O3 -flto -lpthread -lz -lssl -lcrypto -luWS -lboost_regex -o mymain.exe  

//g++ -std=c++14 mymain.cpp lib/GZipCodec/*.cpp lib/drecho/*.cpp lib/ltalloc/*.cpp -Wall -Wno-multichar -pedantic -O3 -flto -lpthread -lz -lssl -lcrypto -luWS -lboost_regex -lboost_wave -o mymain.exe  

//adding boost::wave need 2 additional libs boost_system & boost_filesystem
//g++ -std=c++14 mymain.cpp lib/GZipCodec/*.cpp lib/drecho/*.cpp lib/ltalloc/*.cpp -Wall -Wno-multichar -pedantic -O3 -flto -lpthread -lz -lssl -lcrypto -luWS -lboost_regex -lboost_wave -lboost_system -lboost_filesystem -o mymain.exe

//adding boost::wave need ONLY 1 additional libs boost_system
g++ -std=c++14 mymain.cpp lib/GZipCodec/*.cpp lib/drecho/*.cpp lib/ltalloc/*.cpp -Wall -Wno-multichar -pedantic -O3 -flto -lpthread -lz -lssl -lcrypto -luWS -lboost_regex -lboost_wave -lboost_system -o mymain.exe
