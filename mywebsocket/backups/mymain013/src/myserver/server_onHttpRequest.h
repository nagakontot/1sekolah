...
public:
    ...
    {
        //for ( auto p : myfactory[Ehtmlpage] )delete p;
        
        //vector<std::stringstream*> v;
        //for (Tss::iterator it = myfactory[Ehtmlpage].as<Tss>().begin(); it != myfactory[Ehtmlpage].as<Tss>().end(); ++it) 
        //{   delete *it; 
        //}
