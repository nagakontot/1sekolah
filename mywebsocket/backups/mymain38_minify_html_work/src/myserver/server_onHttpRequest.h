            ...
            {   // control the contents
                ...
                */
                ...
                {   std::cout<<"\nSUCCESS, JWT is verified.";
                    ...
                    res->end(DHTMLPAGE[mymap["/main_gzip.html"]]->str().data(),DHTMLPAGE[mymap["/main_gzip.html"]]->str().length());
                ...
                {   std::cout<<"\nFAIL, JWT is NOT verified.";
                    ...
                    res->write((char *) header.data(), header.length());
                    res->end(DHTMLPAGE[mymap["/index_gzip.html"]]->str().data(),DHTMLPAGE[mymap["/index_gzip.html"]]->str().length());
...
//#define DHTMLPAGE myfactory[Ehtmlpage].as<Tss>()
	    ...
	    *DHTMLPAGE[mymap["/index.html"]]<< std::ifstream ("./public/index.html").rdbuf();
        ...
        ///////////////////////////////////////////////////////////////
        std::string minifyData(DHTMLPAGE[mymap["/index.html"]]->str());
        minifyhtml(&minifyData);

        std::string compressedData;

        //INSERTMAP("/index_minify.html",myfilecounter);
	    //*DHTMLPAGE[mymap["/index_minify.html"]]<< std::ifstream ("./public/index_minify.html").rdbuf();
        //GZipCodec::Compress(DHTMLPAGE[mymap["/index_minify.html"]]->str(), compressedData);
        ...
        /////////////////////////////////////////////////////////////////////
        //need curly braces for scope to auto close file index_gzip.html
        ...
        INSERTMAP("/index_gzip.html",myfilecounter);
        //*DHTMLPAGE[mymap["/index_gzip.html"]]<< std::ifstream ("./public/index_gzip.html").rdbuf(); 
        DHTMLPAGE[mymap["/index_gzip.html"]]->str(compressedData);  //clear up
        if (!DHTMLPAGE[mymap["/index_gzip.html"]]->str().length())  {   std::cerr << "Failed to load index_gzip.html" << std::endl;return -1;}
	    ...
	    *DHTMLPAGE[mymap["/main.html"]]<< std::ifstream ("./public/main.html").rdbuf();
        ...
        std::string().swap(compressedData);
        GZipCodec::Compress(DHTMLPAGE[mymap["/main.html"]]->str(), compressedData);

        INSERTMAP("/main_gzip.html",myfilecounter);
        DHTMLPAGE[mymap["/main_gzip.html"]]->str(compressedData);  //clear up
        if (!DHTMLPAGE[mymap["/main_gzip.html"]]->str().length())  {   std::cerr << "Failed to load main_gzip.html" << std::endl;return -1;}
        ...
        {   ///////////////////////////////////////////////////////////////////////////////
            ...
            if (url == "/") 
            {   if(s1=="gzip")
                {   std::cout<<"\nGET: res index_gzip.html is already exist in map[1], myfilecounter="<<myfilecounter;
                    res->write((char *) header.data(), header.length());
                    res->end(DHTMLPAGE[mymap["/index_gzip.html"]]->str().data(),DHTMLPAGE[mymap["/index_gzip.html"]]->str().length());
                }
                else
