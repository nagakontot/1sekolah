"use strict"
	...
	*/
	...
	{	constructor(fps,width,height)
		...
		{	var promise = await new Promise((resolve, reject) =>
			{	window.setTimeout(()=>
				{	var params1=	[	[ [1.0,  0.2,  0.5], window.gTexLoader.load("https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake1.png"), 0.8],
										[ [0.95, 0.1,  0.5], window.gTexLoader.load("https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake2.png"), 0.5],
										[ [0.90, 0.05, 0.5], window.gTexLoader.load("https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake3.png"), 0.3],
										[ [0.85, 0,    0.5], window.gTexLoader.load("https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake4.png"), 0.2],
										[ [0.80, 0,    0.5], window.gTexLoader.load("https://github.com/nagakontot/1sekolah/raw/master/mywebsocket/mymain/public/textures/sprites/snowflake5.png"), 0.1]
									];
