...
public:    
    ...
    static std::vector<std::stringstream*>  htmlpage;
    //static memo::factory< int >             myfactory;
...
template<class T>std::vector<std::stringstream*>    baseUWS<T>::htmlpage;
//template<class T>memo::factory<int>                 baseUWS<T>::myfactory;
