			...
			*/
			...
			{	window.setTimeout(()=>
				{	//var size	= {radius:250,widthSegments:60,heightSegments:40};
					...
					{	reject("create_ShaderSkybox(), mysky is undefined!");
					}
				},0);
			});
			return promise;    			
		...
		{	var promise = await new Promise((resolve, reject) =>
			{	window.setTimeout(()=>
				{	var anis = this.getMaxAnisotropy();
					...
					{	reject("create_Minecraft() failed, mysky is undefined!");
					}
		...
		{	var promise = await new Promise((resolve, reject) =>
			{	window.setTimeout(()=>
				{	var params1=	[	[ [1.0,  0.2,  0.5], window.gTexLoader.load("textures/sprites/snowflake1.png"), 0.8],
					...
					{	reject("create_particle1(), mysp is undefined!");
					}
				},0);
			});
			return promise;           	
		...
		{	//var pos = {x:83,y:-3,z:66};
			...
			{	window.setTimeout(()=>
				{	var pos			= {x:6,			y:-1.59,		z:85};		
					...
					{	reject("create_house1(), obj is undefined!");
					}
				},0);
			});
			return promise;        	
		...
		{	//var pos			= {x:0,			y:-1,		z:0};		
			...
			{	window.setTimeout(()=>
				{	var pos			= {x:0,			y:-1,		z:0};		
					...
					{	reject("create_castle01(), obj is undefined!");
					}
		...
		{	//var pos			= {x:39.75,		y:-24.05,		z:-24.325};		
			...
			{	window.setTimeout(()=>
				{	var pos			= {x:39.75,		y:-24.05,		z:-24.325};		
					...
					var obj 		= new CLoadModel_Obj(glscene,'models/building1/','building1.mtl','building1.obj',pos,scale);
					
					if(obj)
					{	resolve(obj);
					}
					else
					{	reject("create_building1(), obj is undefined!");
					}
		...
		{	//var pos			= {x:0,			y:-1.99,	z:0};		
			...
			{	window.setTimeout(()=>
				{	var pos			= {x:0,			y:-1.99,	z:0};		
        			...
        			//this.building3  = new CLoadModel_Obj(glscene,'models/building3/','building3.mtl','building3.obj',pos,scale);
        			//return new CLoadModel_Obj(glscene,'models/building3/','building3.mtl','building3.obj',pos,scale);
					var obj			= new CLoadModel_Obj(glscene,'models/building3/','building3.mtl','building3.obj',pos,scale);
		...
		{	var promise = await new Promise((resolve, reject) =>
			{	window.setTimeout(()=>
				{	var anis = this.getMaxAnisotropy();
					...
					{	reject("create_plane(), plane is undefined!");
					}
				},0);
			});
			return promise;
		...
		{	var promise = await new Promise((resolve, reject) =>
			{	window.setTimeout(()=>
				{	//var css3Diframe = new CElement(url,600,120,600, -Math.PI/2 );
					...
					{	reject("create_css3Diframe_rchat(), css3Diframe is undefined!");
					}
				},0);
			});
			return promise;
